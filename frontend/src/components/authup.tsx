        ...
        <div className=" flex justify-center w-full max-w-[600px] bg-cyan rounded-lg shadow bg-stone-900">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8]">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                <div>
                  <label className="block mb-2 text-sm font-medium text-cyan-600">Username</label>
                ...
                <div>
                  ...
                  <input placeholder="johndoe@gmail.com" className="bg-stone-600 border border-gray-300 text-cyan-600 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-[400px] p-2.5" onChange={(e)=>{
                    setuserDetails(c=>({
                      ...c,
                ...
                <div>
                  ...
                  <input placeholder="••••••••" className="bg-stone-600 border border-gray-300 text-cyan-600 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-[400px] p-2.5" onChange={(e)=>{
                    setuserDetails(c=>({
                      ...c,
                ...
                Already have an account? <Link to={"/Signin"} className="no-underline hover:underline">Login here</Link>
                </p>
                </div>
              </form>
            </div>
